...
let a = prompt("Ingresa el primer numero: ", 12);
let b = prompt("Ingresa el segundo numero: ", 1);
if ( a > b ) {
    console.log(`la resta es: ${a-b}, con signo ${(toString(a-b).startsWith(``))? "Positivo" : "Negativo"}`);
} else {
    console.log(`la resta es: ${a-b}, con signo ${(toString(a-b).startsWith(``))? "Negativo" : "Positivo"}`);
}
